...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-slate-950 py-20 text-white sm:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <form onSubmit={handleSubmit} className="glass rounded-2xl p-5 sm:p-6">
            <div className="grid gap-4">
              ...
              <button className="magnet rounded-full bg-white px-5 py-3 font-semibold text-slate-900 hover:bg-white/90"><span>Lähetä</span></button>
            </div>
          </form>
